...
import 'package:dw3_pizza_api/application/config/service_locator_config.dart';
import 'package:dw3_pizza_api/application/middlewares/middlewares.dart';
import 'package:dw3_pizza_api/application/routers/router_configure.dart';
...
void main(List<String> args) async {
  ...
  var handler = const shelf.Pipeline()
      ...
      .addMiddleware(cors())
      .addMiddleware(
          (defaultResponseontentType('application/json;charset=utf-8')))
      .addHandler(appRouter);

  var server = await io.serve(handler, _hostname, port);
  print('Executando em.:  http://${server.address.host}:${server.port}');
}
